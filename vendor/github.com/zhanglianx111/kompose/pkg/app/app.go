...
import (
	...
	"github.com/zhanglianx111/kompose/pkg/loader"
	"github.com/zhanglianx111/kompose/pkg/transformer"
	"github.com/zhanglianx111/kompose/pkg/transformer/kubernetes"
	"github.com/zhanglianx111/kompose/pkg/transformer/openshift"
)
...
func Convert(opt kobject.ConvertOptions) ([]byte, error) {
	...
	// Print output
	data, err := kubernetes.PrintList(objects, opt)
	if err != nil {
		log.Fatalf(err.Error())
		return []byte{}, err
	}
